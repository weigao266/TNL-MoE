...
if __name__ == "__main__":
    ...
    parser.add_argument('--select_file_path', type=str, default="")
    ...
    parser.add_argument('--convert_type', type=str, default="TNLMoEForCausalLM", choices=("TNLMoEModel", "TNLMoEForCausalLM", "TNLMoEForSequenceClassification"))
    ...
    if args.convert_type == "TNLMoEModel":
        convert_tnl_model(
            args.model_path,
    ...
    elif args.convert_type == "TNLMoEForCausalLM":
        convert_tnl_model_for_causal_lm(
            args.model_path,
            args.split_file_path,
            args.select_file_path,
